var flashcards = {
  ...
  "Stoichiometry": [
    { "section": "12.1 Avogadro’s Number and the Mole", "question": "What is Avogadro’s number and what does it represent?", "answer": "Avogadro’s number is 6.02 x 10^23. It represents the number of entities (atoms, molecules, ions, etc.) in one mole of a substance." },
    { "section": "12.1 Avogadro’s Number and the Mole", "question": "What is the definition of a mole in chemistry?", "answer": "A mole is the amount of a substance that contains as many entities as there are atoms in 12 grams of carbon-12, which is 6.02 x 10^23 entities." },
    { "section": "12.2 Molar Mass", "question": "What is molar mass?", "answer": "Molar mass is the mass in grams of one mole of a substance, with units of g/mol. It is numerically equal to the atomic or molecular mass in amu, but in grams per mole." },
    { "section": "12.2 Molar Mass", "question": "How do you calculate the molar mass of a compound?", "answer": "Add up the atomic masses (from the periodic table) of all atoms in the compound’s formula." },
    { "section": "12.2 Molar Mass", "question": "What is the molar mass of Cl2?", "answer": "70.90 g/mol (2 x 35.45 g/mol for each Cl atom)." },
    { "section": "12.2 Molar Mass", "question": "What is the molar mass of H2O?", "answer": "18.02 g/mol [(2 x 1.01) + 16.00]." },
    { "section": "12.3 Mole Calculations", "question": "How do you convert from moles to particles?", "answer": "Multiply the number of moles by Avogadro’s number (6.02 x 10^23 entities/mol)." },
    { "section": "12.3 Mole Calculations", "question": "How do you convert from particles to moles?", "answer": "Divide the number of particles by Avogadro’s number (6.02 x 10^23 entities/mol)." },
    { "section": "12.3 Mole Calculations", "question": "How do you convert from grams to moles?", "answer": "Divide the mass in grams by the molar mass (g/mol) of the substance." },
    { "section": "12.3 Mole Calculations", "question": "How do you convert from moles to grams?", "answer": "Multiply the number of moles by the molar mass (g/mol) of the substance." },
    { "section": "12.4 Molar Volume", "question": "What is the molar volume of a gas at STP?", "answer": "22.4 L per mole at standard temperature and pressure (STP: 0°C, 1 atm)." },
    { "section": "12.4 Molar Volume", "question": "What is the formula for gas density at STP?", "answer": "Density = Molar Mass / Molar Volume (g/L at STP)." },
    { "section": "12.5 Percent Composition", "question": "How do you calculate percent composition of an element in a compound?", "answer": "Divide the total mass of the element in one mole of the compound by the molar mass of the compound, then multiply by 100%." },
    { "section": "12.5 Percent Composition", "question": "What is the percent composition of H in H2O?", "answer": "11.2% H [(2.02 g H / 18.02 g H2O) x 100]." },
    { "section": "12.5 Percent Composition", "question": "What is the percent composition of O in H2O?", "answer": "88.79% O [(16.00 g O / 18.02 g H2O) x 100]." },
    { "section": "13.1 Mole Ratio", "question": "What is a mole ratio?", "answer": "A mole ratio is a ratio between the amounts in moles of any two compounds involved in a chemical reaction, based on the coefficients in the balanced equation." },
    { "section": "13.1 Mole Ratio", "question": "How do you use mole ratios to solve stoichiometry problems?", "answer": "Use the coefficients from the balanced equation to set up conversion factors between moles of different substances." },
    { "section": "13.2 Mass-Mass Stoichiometry", "question": "What are the steps for solving mass-mass stoichiometry problems?", "answer": "1) Convert grams of given to moles using molar mass. 2) Use mole ratio to convert to moles of unknown. 3) Convert moles of unknown to grams using its molar mass." },
    { "section": "13.2 Mass-Mass Stoichiometry", "question": "What is the answer to: Calculate the mass of H2 required to react with 8.75 g O2 (O2 + 2 H2 → 2 H2O)?", "answer": "1.10 g H2." },
    { "section": "13.3 Mass-Volume Stoichiometry", "question": "What is Avogadro's molar volume for gases at STP?", "answer": "22.4 L/mol." },
    { "section": "13.3 Mass-Volume Stoichiometry", "question": "What are the steps for mass-volume stoichiometry problems?", "answer": "1) Convert grams or liters of given to moles. 2) Use mole ratio to get moles of unknown. 3) Convert moles of unknown to grams or liters as needed." },
    { "section": "13.3 Mass-Volume Stoichiometry", "question": "How many liters of O2 are needed to react with 0.234 g SO2 at STP (2 SO2 + O2 → 2 SO3)?", "answer": "0.0409 L O2." },
