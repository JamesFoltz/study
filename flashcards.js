...
"Chain of command": [
  ...
  { section: "", question: "What is the 10th Amendment?", answer: "It states that states get their own rights (powers not delegated to the national government are reserved to the states)." },
  { section: "", question: "Where is federal power stated in the Constitution?", answer: "Article I, Section 8 — the Elastic Clause (aka the Necessary and Proper Clause)." },
  { section: "", question: "What are implied powers?", answer: "Powers that are not actually in the Constitution but are allowed so the government can do its job." },
  { section: "", question: "What are inherent powers?", answer: "Powers that come with being a government." },
  { section: "", question: "What is dual federalism?", answer: "The states and the federal government are equal partners with equal separate areas of authority (like how a dual class in school works with a college to get college and HS credit)." },
  { section: "", question: "When did dual federalism start to fade away?", answer: "After the Civil War." },
  { section: "", question: "How long did dual federalism dominate America?", answer: "The first 100 years." },
  { section: "", question: "What is cooperative federalism?", answer: "Power shifted at the beginning of the 20th century; the federal government gained more power to help the states and the country, like collecting taxes with the 16th Amendment and pulling the country out of the Great Depression." },
  { section: "", question: "What powers are granted to the national government?", answer: "Regulate interstate commerce, coin money, declare war, create and maintain an army and navy." },
  { section: "", question: "What powers are granted to the state government?", answer: "Conduct elections, establish commerce within the state, protect public health and safety, all other powers not delegated to the national government nor denied to the states." },
  { section: "", question: "What powers are granted to both the national and state government?", answer: "Collect taxes, borrow money, make and enforce laws, establish courts." },
  { section: "", question: "What were the facts of McCulloch v. Maryland?", answer: "The state of Maryland voted to tax any bank not chartered by the state. James McCulloch, head of the Baltimore branch of the national bank, refused to pay the tax. Maryland sued McCulloch and won in state court, leading to an appeal to the U.S. Supreme Court." },
  { section: "", question: "What was the issue in McCulloch v. Maryland?", answer: "Did Congress have the constitutional authority to charter a national bank? Did Maryland's tax law unconstitutionally interfere with federal powers?" },
  { section: "", question: "What was the conclusion of McCulloch v. Maryland?", answer: "The Court ruled unanimously that Congress had the power to incorporate the bank. Maryland could not tax an instrument of the federal government (the federal bank)." },
  { section: "", question: "Did McCulloch v. Maryland increase or decrease federal power?", answer: "Increased federal power." },
  { section: "", question: "What were the facts of United States v. Lopez?", answer: "Alfonso Lopez Jr. was a 12th-grade high school student in San Antonio, Texas. He carried a concealed handgun and bullets into his high school. He was first charged under Texas state law, but those charges were dropped. Federal agents instead charged him with breaking the Gun-Free School Zones Act of 1990. Lopez was found guilty and sentenced to prison, then appealed." },
  { section: "", question: "What was the issue in United States v. Lopez?", answer: "Did Congress have the authority under the Commerce Clause (Article I, Section 8) to pass a law making it a federal crime to possess a firearm in a school zone?" },
  { section: "", question: "What was the conclusion of United States v. Lopez?", answer: "The Supreme Court voted 5–4 in favor of Lopez, striking down the Gun-Free School Zones Act as unconstitutional. It marked the first time in half a century that the Court held Congress had overstepped its power under the Commerce Clause." },
  { section: "", question: "Did United States v. Lopez increase or decrease federal power?", answer: "Decreased federal power." },
  { section: "", question: "What were the facts of Gibbons v. Ogden?", answer: "New York State gave a special license to Fulton and Livingston to run steamboats on state waters. They gave Aaron Ogden permission to run a ferry between New York and New Jersey. Thomas Gibbons started a rival steamboat ferry on the same route with a federal coastal license. Ogden sued Gibbons in New York state court, won, and Gibbons appealed to the Supreme Court." },
  { section: "", question: "What was the issue in Gibbons v. Ogden?", answer: "Does the Commerce Clause allow Congress to regulate navigation and interstate travel? Does a state law that creates a business monopoly over waterways conflict with federal power?" },
  { section: "", question: "What was the conclusion of Gibbons v. Ogden?", answer: "It made the Commerce Clause a core tool for Congress to regulate national business, transport, and economic activity." },
  { section: "", question: "Did Gibbons v. Ogden increase or decrease federal power?", answer: "Really increased federal power." },
  { section: "", question: "What are the arguments for federalism?", answer: "Allows for political experimentation, gets more people involved in government, and allows states to be a 'laboratory' of democracy." },
  { section: "", question: "What are grants in aid?", answer: "Used to influence state policies. Categorical grants have strings attached (e.g., 'I'll give you these dollars IF you do this'). Used to build airports or colleges. Examples: the US threatened to take the Super Bowl away from Arizona because they refused to acknowledge MLK Day, or the federal government funds interstate highways if the drinking age is 21." },
  { section: "", question: "What are block grants?", answer: "Money for a specific thing, but with few strings attached. Money for community development, to counter unemployment, etc." },
  { section: "", question: "What are mandates?", answer: "A direct order from the government. If money isn't provided, it's called an 'unfunded mandate.' Most mandates are about civil rights and environmental protections." },
  { section: "", question: "What were the core beliefs and goals of Anti-Federalists?", answer: "1) Reflected philosophies of Jean-Jacques Rousseau that people are naturally good until corrupted by societal greed for power. 2) Feared a powerful central government would naturally seek more power and transform into a tyranny. 3) Believed states are the soul of a confederation rather than one consolidated national government. 4) Maintained that external and internal controls are required because men are not angels." },
  { section: "", question: "What was the Anti-Federalist position on the Bill of Rights?", answer: "It was proposed to limit central government power and secure the minority against majority tyranny. Written rules and ideals to guarantee natural rights and prevent government infringement. Addressed individual freedoms including speech, religion, press, petition, and peaceful protest." },
  { section: "", question: "What philosophical tradition did Anti-Federalists reflect?", answer: "The philosophies of Jean-Jacques Rousseau — that people are naturally good until corrupted by societal greed for power." },
  { section: "", question: "What event did Federalists cite as evidence for needing a strong military?", answer: "Shays' Rebellion." },
  { section: "", question: "What amendment gave the federal government the power to collect taxes?", answer: "The 16th Amendment." },
  { section: "", question: "What was significant about U.S. v. Lopez in terms of the Commerce Clause?", answer: "It marked the first time in half a century that the Court held Congress had overstepped its power under the Commerce Clause." },
  { section: "", question: "What were the Articles of Confederation?", answer: "The first attempt of the US forming a national government. In effect from March 1st, 1781 to June 21st, 1788." },
  { section: "", question: "Why did the Articles of Confederation fail — leadership issues?", answer: "No national judiciary (Supreme Court), no foreign affairs head, no way to deal with internal and external threats (no formal military)." },
  { section: "", question: "Why did the Articles of Confederation fail — economic issues?", answer: "Congress could not regulate trade, no uniform system of currency, no power to tax (taxes were voluntary)." },
  { section: "", question: "Why did the Articles of Confederation fail — legislative issues?", answer: "Each state had one vote, 9/13 states needed to pass a law, impractical amendment process (13/13 states needed to ratify an amendment)." },
  { section: "", question: "What constitutional quote fixed the leadership problems of the AoC?", answer: "'The executive Power shall be vested in a President of the United States of America.' (Article 2). People would vote in representatives to lead a specific branch or party." },
  { section: "", question: "What constitutional quote fixed the economic problems of the AoC?", answer: "'The Congress shall have Power To lay and collect Taxes, Duties, Imposts and Excises [...] To regulate Commerce with foreign Nations' (Article 1, Section 8)." },
  { section: "", question: "What constitutional quote fixed the legislative problems of the AoC?", answer: "Majority vote wins (Article 2)." },
  { section: "", question: "What event led to the Constitutional Convention?", answer: "Shays' Rebellion — the laws treated farmers unfairly, considered the last straw by the people. Lasted from 1786-1787. It showed how flawed the AoC was, proving their inability to deal with a crisis timely and efficiently because they were without a military." },
  { section: "", question: "When did the Constitutional Convention start and who presided over it?", answer: "May 25th, 1787. Presided over by George Washington." },
  { section: "", question: "How many delegates attended the Constitutional Convention?", answer: "55 delegates from all 13 states (55 out of 74 came)." },
  { section: "", question: "What was the Virginia Plan?", answer: "Proposed by James Madison. Wanted the legislature to have 2 houses, 3 branches of government, executive elected by congress, popular sovereignty (citizens involved, power belongs to the people). Favored the more populated states." },
  { section: "", question: "What was the New Jersey Plan?", answer: "Proposed by William Paterson. Legislature composed of one house (each state only got one vote). Legitimacy from the states. Favored the less populated states." },
  { section: "", question: "What was the Great Compromise?", answer: "Two chambers in Congress: one based on population (House of Representatives) and the other with equal representation (Senate gave each state two equal votes)." },
  { section: "", question: "What was the 3/5ths Compromise?", answer: "Slaves got 3/5th of a vote for purposes of the census." },
  { section: "", question: "What was the Slave Trade Compromise?", answer: "No law could be passed by Congress banning the slave trade until 1808." },
  { section: "", question: "When did the Constitution become official and what was needed for ratification?", answer: "September 17th, 1787. Needed to be ratified by 9 states." },
  { section: "", question: "What are the three branches of government?", answer: "1) Legislature makes the laws (Congress, House of Representatives, Senate). 2) Executive enforces the laws (President, Vice President, Cabinet). 3) Judicial interprets the laws (Supreme Court, federal judges)." },
  { section: "", question: "What is separation of powers?", answer: "Each of the three branches of government would be given independent powers so that no branch could operate with total independence. Power would not be divided absolutely but would be shared among the various branches." },
  { section: "", question: "What are checks and balances?", answer: "Each branch could check the powers of the other two to a certain extent. President could veto legislation, Congress could impeach the president, and the Supreme Court could interpret the laws passed by the other two." },
  { section: "", question: "How did Madison keep the government beyond the control of the masses?", answer: "Only the House of Representatives had members directly elected by the majority. State legislatures selected senators and the electoral college chose the president. Judges were nominated by the president and served for life." },
  { section: "", question: "What rules did the Constitution establish for the states?", answer: "States have to respect each other's laws, states cannot discriminate against a citizen of another state or interfere with traveling, and each state is guaranteed a representative form of government." },
  { section: "", question: "How can the Constitution be amended?", answer: "Proposal needs 2/3 of Congress to propose an amendment, 3/4 of states need to ratify the proposed amendment. Alternatively, 2/3 of state legislatures need to ask Congress for a national convention, and 3/4 of states hold a convention to vote on ratification." },
  { section: "", question: "What is the Supremacy Clause?", answer: "Establishes that the federal Constitution and federal law take precedence over state laws and constitutions. Federal law > state law." },
  { section: "", question: "What is judicial review and what case established it?", answer: "Marbury v. Madison (1803) — the first major court ruling. Because the Constitution is the supreme law of the land, the Supreme Court can declare any law that contradicts the Constitution as unconstitutional." },
  { section: "", question: "What are the grounds for impeachment?", answer: "If the president commits treason, bribery, or other crimes and misdemeanors." },
  { section: "", question: "Which presidents were impeached or resigned?", answer: "Three presidents were impeached: Andrew Johnson, Bill Clinton, and Donald Trump. Richard Nixon resigned once he was caught spying on the Democrats." }
]   
